...
import ExpenseRatioExitLoad from "./accordions/ExpenseRatioExitLoad";
import FundHouseAndInvestmentObjective from "./accordions/FundHouseAndInvestmentObjective";
import ReturnAndRanking from "./accordions/ReturnAndRanking";
      ...
      <AccordionItem value="item-5" className="px-4 py-3 sm:px-0 sm:py-4">
        ...
        <AccordionContent className="mt-2 space-y-6">
          {fund.fund_manager?.split(";").map((manager, idx) => (
            ...
            >
              <Avatar className="border border-muted-foreground sm:size-10">
