    ...
    <div className="mx-auto flex min-h-svh flex-col items-center justify-center px-4">
      ...
      <div className="mt-30 flex w-full flex-col items-center justify-center gap-4 sm:mt-18 sm:flex-row">
        <Button
          ...
          onClick={googleLogin}
          disabled={isPending}
          className="text-md h-11.5 rounded-3xl border-b !px-16 font-[550] active:scale-95 sm:rounded-full sm:border-r sm:!px-8"
        >
        ...
        <Button
          ...
          className="text-md h-11.5 rounded-3xl border-b !px-16 font-[550] active:scale-95 sm:h-12 sm:rounded-full sm:border-r sm:!px-8 sm:shadow-xs"
        >
