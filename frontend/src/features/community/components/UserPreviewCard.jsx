  ...
  return (
    <>
      ...
      >
        ...
        <div className="bg-muted/60 m-2 flex h-16 items-center justify-around rounded-3xl text-sm tabular-nums">
          <div className="flex flex-col items-center gap-0.5 sm:gap-1">
            <span className="text-[0.725rem] text-muted-foreground">Funds</span>
            <span className="text-md font-medium">
              {user.portfolio.fundCount}
            </span>
          </div>
          <div className="flex flex-col items-center gap-0.5 sm:gap-1">
            <span className="text-[0.725rem] text-muted-foreground">SIPs</span>
            <span className="text-md font-medium">
              {user.portfolio.sipCount}
            </span>
          </div>
          <div className="flex flex-col items-center gap-0.5 sm:gap-1">
            <span className="text-[0.725rem] text-muted-foreground">Invested</span>
            <span className="text-md font-medium">
