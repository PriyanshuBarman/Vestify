...
function ScrollIndicator() {
  ...
  return (
    <div className="absolute bottom-4 left-1/2 flex -translate-x-1/2 animate-bounce flex-col items-center">
      <ChevronsDownIcon className="text-muted-foreground/60 size-9 stroke-[1.5px] transition-transform duration-300 group-hover:translate-y-1 sm:size-14 sm:stroke-1" />
    </div>
  );
}
