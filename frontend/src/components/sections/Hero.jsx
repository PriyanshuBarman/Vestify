...
function Hero() {
  ...
  return (
    <section className="flex min-h-svh flex-col items-center justify-center">
      <div className="relative flex max-w-5xl flex-col items-center justify-center px-4">
...
function Heading() {
  return (
    <h2 className="mt-6 text-center text-[2.375rem] leading-tight font-[550] sm:text-7xl sm:tracking-tight">
      <span>Virtually</span> Invest in Mutual funds with{" "}
      <span className="text-[2.3rem] sm:text-7xl">zero financial risk</span>
    </h2>
  );
}
