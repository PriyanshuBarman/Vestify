...
function Community({ className }) {
  ...
  const paginate = (newDirection) => {
    const newIndex =
      (activeIndex + newDirection + demoUsers.length) % demoUsers.length;
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col items-center text-center">
        ...
        <motion.p
          className="text-muted-foreground mt-4 flex max-w-md text-sm sm:mt-5 sm:text-base"
          variants={itemVariants}
        >
        ...
        {isMobile ? (
          ...
          >
            <div className="flex gap-6 lg:gap-12">
                ...
                <AnimatePresence mode="wait">
                  ...
                  >
                    <div className="flex items-center gap-5 lg:gap-6">
                      ...
                      >
                        <TrendingUpIcon className="size-6 lg:size-7" />
              ...
              <motion.div
                className="flex w-72 flex-col gap-4 lg:w-md"
                initial={{ opacity: 0, scale: 0.95, filter: "blur(8px)" }}
                whileInView={{ opacity: 1, scale: 1, filter: "blur(0px)" }}
                viewport={{ once: true }}
                transition={{ duration: 0.8, ease: [0.22, 1, 0.36, 1] }}
